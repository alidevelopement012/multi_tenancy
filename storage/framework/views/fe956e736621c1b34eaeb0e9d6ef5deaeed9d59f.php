<div class="main-header">
  ...
  <div class="logo-header" <?php if(request()->cookie('admin-theme') == 'dark'): ?> data-background-color="dark2" <?php endif; ?>>
    ...
    <a href="javascript:void(0)" class="logo" target="_blank">
      <h1>MVP</h1>
    </a>
...
<?php /**PATH /Users/muhammadusman/Sites/eorder-31nulled/codecanyon-50718143-eorder-multitenant-restaurant-food-ordering-website-saas/new-project/multi_tenancy/resources/views/admin/partials/top-navbar.blade.php ENDPATH**/ ?>