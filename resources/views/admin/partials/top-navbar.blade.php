              ...
              <li>
                <div class="user-box">
                  ...
                  <div class="u-text">
                    ...
                    <p class="text-muted">{{Auth::guard('admin')->user()->email}}</p><a href="{{route('admin.edit.profile')}}" class="btn btn-xs btn-secondary btn-sm">{{__('Edit Profile')}}</a>
                  </div>
                </div>
              </li>
              <li>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="{{route('admin.edit.profile')}}">{{__('Edit Profile')}}</a>
                <div class="dropdown-divider"></div>
